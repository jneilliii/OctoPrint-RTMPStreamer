...
plugin_identifier = "rtmpstreamer"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_rtmpstreamer"
...
# module
plugin_description = """A plugin to re-encode the mjpg stream to an rtmp server of your choice."""
...
plugin_url = "https://github.com/jneilliii/OctoPrint-RTMPStreamer"
